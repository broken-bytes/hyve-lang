...
const config: Config = {
  title: 'hyve-lang',
  tagline: 'The Hyve Programming Language',
  ...
  projectName: 'Hyve', // Usually your repo name.
  ...
  themeConfig: {
    ...
    image: 'img/hyve-social-card.png',
    navbar: {
      title: 'Hyve Programming Language',
      logo: {
        alt: 'Logo',
        src: 'img/logo.png',
      },
      items: [
        ...
        {
          href: 'https://github.com/broken-bytes/Hyve',
          label: 'GitHub',
          position: 'right',
        },
      ],
