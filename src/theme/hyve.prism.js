(function (Prism) {
    ...
    Prism.languages.hyve = {
        ...
        'string': [
            ...
            // (Remove the multiline string pattern - it doesn't seem to be part of Hyve)
        ],
        'char': {
        ...
        'builtin-type': {
            pattern: /\b(?:Int)\b/, // Add Hyve-specific built-in types
            alias: 'keyword' 
        },
        'keyword': keyword,
    ...
    Prism.languages.hyve['class-name'].forEach(function (obj) {
        if (obj.inside === null) {
            obj.inside = Prism.languages.hyve;
        }
    });
